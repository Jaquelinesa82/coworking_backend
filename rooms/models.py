...
class Room(models.Model):
    ...
    participants = models.ManyToManyField(
        CustomUser,
        through='participant.Participant',
    ...
    privacy = models.CharField(
        max_length=20, choices=[('public', 'Pública'), ('private', 'Privada')], default='private'
    )
...
class Tool(models.Model):
    ...
    tool_type = models.CharField(
        max_length=20,
        choices=[('interactive', 'Interactive'), ('visual', 'Visual')],
        verbose_name=_('Tipo da ferramenta'),
    )
...
class Event(models.Model):
    ...
    event_type = models.CharField(
        max_length=20, choices=[('palestra', 'Palestra'), ('workshop', 'Workshop'), ('webinar', 'Webinar')]
    )
